...
import {selectAllProducts,fetchAllProuctsAsync,fetchProductsByFilltersAsync}from'../productSlice'
...
const oldproducts = [
  {
    ...
    thumbnail: "Front of men's Basic Tee in black.",
    price: "$35",
    color: "Black",
  },
  {
...
const category = [
    ...
    { value: 'jhj', label: 'lkjl', checked: false },
    { value: 'ljl', label: 'ljl', checked: false },
  ...
  const [filter,setFilters] = useState({})
   ...
   const handleFilter =(e,section,option)=>{
    // console.log(section.id,option.value)
      ...
      setFilters({...filter,[section.id]:option.value})
      console.log(filter)
 
    disatch(fetchProductsByFilltersAsync(filter))
    
   }

  useEffect(()=>{
    disatch(fetchAllProuctsAsync())
  },[disatch])
                            ...
                            <Link to="/productDetails">
                              <div key={product.id} className="group relative">
                                ...
                                <div className="mt-4 flex justify-between">
                                  ...
                                  <p className="text-sm font-medium block line-through text-gray-900">
                                   Price {product.price}      
